...
async function seedDemoAccounts() {
  ...
  try {
    ...
    const sampleConsents = [
      {
        userId: (await pool.query("SELECT user_id FROM auth_credentials WHERE email = 'demo@consentire.com'")).rows[0]?.user_id,
    ...
    console.log('═══════════════════════════════════════════════');
    console.log('\n👤 Regular User:');
    console.log('   Email:    demo@consentire.com');
    console.log('   Password: demo123');
    console.log('\n🔧 Admin:');
    console.log('   Email:    admin@consentire.com');
    console.log('   Password: admin123');
    console.log('\n🏢 Controller (Organization):');
    console.log('   Email:    controller@consentire.com');
    console.log('   Password: controller123');
    console.log('\n👥 Additional Test Users:');
    console.log('   Email:    user1@consentire.com');
    console.log('   Password: user123');
    console.log('   Email:    user2@consentire.com');
    console.log('   Password: user123');
    console.log('═══════════════════════════════════════════════\n');
  } catch (error) {
